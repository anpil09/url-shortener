...
public interface UrlGenerator {
     ...
     *
     * @param urlString        Original in {@link String} form to shorten
     ...
     */
    String generateBySeoKeyword(String urlString, String seoKeyword);
     ...
     * @return Shortened URL
     */
    String generateWithRandomPath(String urlString);
